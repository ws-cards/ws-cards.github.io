	...
	console.log("進入繪圖區:"+cardNum);
        ...
        myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: '價格',
                    borderColor: '#4F46E5', // 現代靛藍線條
                    backgroundColor: 'rgba(79, 70, 229, 0.1)', // 底部極淡的漸層
                    borderWidth: 3, // 線條加粗
                    pointRadius: 0, // 預設隱藏資料點，畫面更乾淨
                    pointHoverRadius: 6, // 滑鼠移過去才顯示點
                    pointBackgroundColor: '#FFFFFF',
                    pointBorderColor: '#4F46E5',
                    pointBorderWidth: 2,
                    data: cardData,
                    lineTension: 0.3 // 讓折線變成平滑的曲線 (Bezier curve)
                }],
            },
            options: {
                responsive: true,
                ...
                tooltips: {
                    mode: 'index',
                    intersect: false,
                    backgroundColor: 'rgba(15, 23, 42, 0.9)', // 深色現代提示框
                ...
                scales: {
                    xAxes: [{
                        gridLines: { display: false }, // 隱藏垂直網格線，視覺更乾淨
                        ticks: { maxTicksLimit: 6, fontColor: '#64748B' } // 限制日期標籤數量
                    }],
                    yAxes: [{
                        gridLines: {
                            color: '#E2E8F0',
                        ...
                        ticks: {
                            fontColor: '#64748B',
                            callback: function(value) { return '¥' + value; } // 加上貨幣符號
                        }
                    }]
                }
            }
