...
function isCardNumberFormat(input) {
  ...
  // 例如: PRD/W01-001, BD/W54-070SSP, SAO/S26-001
...
function parseCardNumber(cardNumber) {
  ...
  // 新增第四部分 SUFFIX
  var suffix = parts[2] + '-' + parts[3]; // 例如: W01-001
  
  return {
    prefix: parts[1],                    // 例如: PRD
    series: parts[1] + '/' + parts[2],   // 例如: PRD/W01  
    fullNumber: cardNumber,              // 例如: PRD/W01-001
    suffix: suffix                       // 例如: W01-001 (新增)
  };
}
