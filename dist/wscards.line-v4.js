...
WSCardsLineApp.prototype.changeStandardAfterChangeNumber = function() {
    ...
    // 為標題選擇器添加預設選項（如果沒有的話）
    if (selectTitle.options.length === 0 || selectTitle.options[0].value !== "") {
        const titleOption = document.createElement("option");
        titleOption.setAttribute("value", "");
        titleOption.appendChild(document.createTextNode("--選擇主題--"));
        selectTitle.insertBefore(titleOption, selectTitle.firstChild);
    }
};
